...
export const personSkills = [
    {
        name:'skills',
        info:['Node.js','PostgreSQL','React','TypeScript','Prisma','NextJs']
    },
    {
        name:'education',
        info:['Soy Henry Fullstack Academy of Code', 'Universidad DaVinci de Guatemala']
    },
    {
        name:'certifications',
        info:['Backend NodeJS Udemy Course', 'Fronted React Udemy Course']
    },
    {
        name:'experience',
